-- =====================================================
-- VERİTABANI YAPISINI TAMAMEN DÜZELT
-- Alt kategoriler ve etkinlik bağlantılarını düzgün kur
-- =====================================================
...
-- 3. TÜM KATEGORİ VE ALT KATEGORİLERİ YENİDEN DÜZENLE
DO $$
DECLARE
  -- Kategori ID'leri
  v_sanat_id UUID;
...
-- =====================================================
-- Artık alt kategoriler ve etkinlikler doğru şekilde bağlı!
-- Etkinlikleri eklemek için ADD_EVENTS_FINAL.sql dosyasını çalıştırabilirsiniz.
